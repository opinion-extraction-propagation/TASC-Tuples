...
public class GenerateDoubleTuples {
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {
			...
			// String positivewordWeightFileName = args[3];
			// String neutralwordWeightFileName = args[4];
			// String negativewordWeightFileName = args[5];
			String sentimentwordWeightFileName = args[2];

			String tuplesFileName = args[3];
			// String positivetuplesString = args[6];
			// String neutraltupleString = args[7];
			// String negativetupleString = args[8];
			...
			try {
				...
				for (ArrayList<String> arrList : positiveArrayList) {
					resultWriter.write(arrList.get(0) + "\t" + arrList.get(2)
